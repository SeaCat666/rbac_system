...
<div class="wrapper">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.lastPage}&size=${pageInfo.pageSize}"
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020-2022 <a href="https://www.hnxinruiedu.com/">研究院研发部</a>.
...
<script>
    ...
    $("#page_count").change(function () {
        ...
        location.href = "${pageContext.request.contextPath}/user/findAll.do?page=1&size=" + options.val();
    });
    // 设置激活菜单
