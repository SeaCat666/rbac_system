                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" onclick="deleteByIds()" class="btn btn-default" title="删除">
                            ...
                            <c:forEach var="product" items="${pageInfo.list}">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button"
                                                onclick="location.href='${pageContext.request.contextPath}/product/updateById.do?id='+${product.id}"
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="page_count">
                                <option value="1"
                                ${pageInfo.pageSize==1?"selected='selected'":''}>1
                                </option>
                                <option value="2"
                                ${pageInfo.pageSize==2?"selected='selected'":''}>2
                                </option>
                                <option value="3"
                                ${pageInfo.pageSize==3?"selected='selected'":''}>3
                                </option>
                                <option value="4"
                                ${pageInfo.pageSize==4?"selected='selected'":''}>4
                                </option>
                                <option value="5"
                                ${pageInfo.pageSize==5?"selected='selected'":''}>5
                                </option>
                            </select> 条
                        </div>
                    </div>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.lastPage}&size=${pageInfo.pageSize}"
...
<script>
    function deleteByIds() {
        var str = "";
        //获取id为dataList div当中所有被选中的多选框checkbox 的value
        $("#dataList input:checkbox:checked").each(function (index) {
            str += $(this).val() + ",";
        });
        location.href = "${pageContext.request.contextPath}/product/delByIds.do?ids=" + str;
    }
    ...
    $("#page_count").change(function () {
        var options = $("#page_count option:selected");
        location.href = "${pageContext.request.contextPath}/product/findAll.do?page=1&size=" + options.val();
    });
