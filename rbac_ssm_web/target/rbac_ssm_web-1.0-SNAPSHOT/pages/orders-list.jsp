...
<body class="hold-transition skin-purple sidebar-mini">
									...
									<c:forEach items="${pageInfo.list}" var="orders">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/updateById.do?id='+${orders.id}">编辑</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li>
									<a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageInfo.lastPage}&size=${pageInfo.pageSize}"
	...
	<script>
		$("#page_count").change(function () {
			...
			location.href = "${pageContext.request.contextPath}/orders/findAll.do?page=1&size=" + options.val();
		});
